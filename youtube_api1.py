...
# '오은영의 금쪽 상담소', '아빠는 꽃중년', '남의 나라 살아보기 선 넘은 패밀리', '채널A 토일드라마 새벽 2시의 신데렐라', '요즘 남자 라이프 신랑수업', '요즘 육아 금쪽같은 내 새끼', '탐정들의 영업비밀', '절친 토크멘터리 4인용 식탁')
programs = ['오은영의 금쪽 상담소', '아빠는 꽃중년', '남의 나라 살아보기 선 넘은 패밀리', '채널A 토일드라마 새벽 2시의 신데렐라', '요즘 남자 라이프 신랑수업', '요즘 육아 금쪽같은 내 새끼', '탐정들의 영업비밀', '절친 토크멘터리 4인용 식탁']
...
# 내림차순 정렬 
# df['view_count'] = df['view_count'].apply(lambda x: int(x))
